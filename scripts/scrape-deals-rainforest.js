...
console.log('🌧️ Starting Rainforest API scraper for Amazon India...');
    ...
    const deals = allProducts
      ...
      .map(item => {
        ...
        return {
          ...
          url: `https://www.amazon.in/dp/${item.asin}?tag=${config.amazonConfig.affiliateTag}`,
          originalUrl: `https://www.amazon.in/dp/${item.asin}`,
          asin: item.asin,
          price: currentPrice,
          currency: '₹',
...
module.exports = { scrapeAmazonIndia };
